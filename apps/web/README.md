...
4. Apply the Auth/RLS migration and create an admin account before treating the public preview as usable. Public access control is handled by Supabase Auth and RLS.
