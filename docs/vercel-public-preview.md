...
Public access control is handled by Supabase Auth and RLS. Apply the latest migrations and create an admin user before treating the preview as usable.
...
2. Access protection: apply Auth/RLS and create an admin account before long-lived public use.
